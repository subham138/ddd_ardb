        ...
        <form method="POST" action="<?php echo site_url("transaction/bank_update") ?>" onsubmit="return valid_data()">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    ...
                    <input type=date name="voucher_dt" class="form-control smallinput_text" value="<?= $head_tag['voucher_date'] ?>" id="date" style="width: 150px;" required />
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" name="inst_num" class="form-control smallinput_text" value="<?= $head_tag['trans_no'] ?>">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="date" class="form-control smallinput_text" name="inst_dt" value="<?= $head_tag['trans_dt'] ?>">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <input type="button" name="submit" id="submit" value="Update" class="btn btn-info" />
                </div>
